...
- while the app is in HEX mode, only HEX event/highlight/filter rules are active;
  decoded text is retained internally but Terminal rules are deliberately skipped;
